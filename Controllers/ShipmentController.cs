...
namespace SMS.Controllers
{
    ...
    public class ShipmentController : Controller
    {
        ...
        // STEP 3: Save to DB and generate Waybill
        // [HttpPost]
        // [ValidateAntiForgeryToken]
        ...
        //     {
        //         TempData["error"] = "Session expired. Please create the shipment again.";
        ...
        //     if (employee == null) 
        //     {
        //         TempData["error"] = "Could not find an employee record for the current user.";
        //         return RedirectToAction("CreateShipment"); 
        //     }
        //
        //     // Recalculate price and apply coupon discount before saving
        ...
        //             {
        //                 discount = finalPriceDetails.TotalToPay * (coupon.DiscountValue / 100);
        //             }
        ...
        //     }
        //     return RedirectToAction("Waybill", new { id = newShipment.Id });
        // }
        
        
        // All other using statements remain the same...
// All other controller methods remain the same...

// --- THIS IS THE ONLY METHOD THAT NEEDS TO BE CHANGED IN THE CONTROLLER ---
[HttpPost]
[ValidateAntiForgeryToken]
public async Task<IActionResult> ConfirmShipment(string couponCode = null)
{
